...
// Route::post('responsavel-titular/boletos', \App\Http\Controllers\Api\Pagamentos\v1\ResponsavelTitular\Boletos\StoreController::class);

// //listar boletos pagos
// Route::get('secretaria/boletos', \App\Http\Controllers\Api\Pagamentos\v1\Secretaria\Boletos\IndexController::class);
// //criar cobrança para o titular
// Route::post('secretaria/boletos', \App\Http\Controllers\Api\Pagamentos\v1\Secretaria\Boletos\StoreController::class);
// //pagar salário do funcionário
// Route::post('secretaria/funcionarios', \App\Http\Controllers\Api\Pagamentos\v1\Secretaria\Funcionario\StoreController::class);
// //listagem de pagamento do funcionário
// Route::get('secretaria/funcionarios', \App\Http\Controllers\Api\Pagamentos\v1\Secretaria\Funcionario\IndexController::class);
    ...
    Route::middleware(['App\Http\Middleware\EnsureSuperAdminHasSchoolId'])->group(function () {
        ...
        Route::middleware(['App\Http\Middleware\EnsureAcademicYearIsSet', 'App\Http\Middleware\CreateCurrentAcademicYearRecord'])->group(function () {
            ...
            Route::middleware(['App\Http\Middleware\EnsureSemesterIsSet'])->group(function () {
                ...
                Route::resource('fees/fee-invoices', \App\Http\Controllers\Api\Pagamentos\FeeSlipController::class);


                // fee slip
                Route::resource('fees/fee-slip', FeeInvoiceRecordController::class);
                //fee routes
